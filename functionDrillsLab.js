...
console.log(exclaimThree(`Stella`));
...
// //CODE HERE
let bestMovie = (str) => console.log(`${str} is the best movie ever!`);

bestMovie(`What about Bob?`);
...
// //CODE HERE
bigName = (str) => console.log(str.toUpperCase());

bigName(sampleString);
...
// //CODE HERE
function chocoFrogGet(spendGold){
  let chocoFrogCost = 3;
  return Math.floor(spendGold / chocoFrogCost);
}

let totalFrogs = chocoFrogGet(104);
...
let totalFrogs2ElectricBoogaloo = chocoFrogGet(104);

console.log(totalFrogs2ElectricBoogaloo);
